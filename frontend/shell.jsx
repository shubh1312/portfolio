...
const CLASS_META = {
  'US Market':           { key:'us',     name:'US Market',     color:'#C7F651', icon:'$' },
  'Indian Stock Market': { key:'ind',    name:'Indian Stocks', color:'#D9C78B', icon:'₹' },
  'Indian Mutual Funds': { key:'mf',     name:'Mutual Funds',  color:'#8BB8D8', icon:'M' },
  'Crypto':              { key:'crypto', name:'Crypto',        color:'#E89B8B', icon:'₿' },
  'Lending':             { key:'lend',   name:'Lending',       color:'#A78BE8', icon:'L' },
};
const CLASS_KEY_TO_META = Object.fromEntries(Object.values(CLASS_META).map(m => [m.key, m]));
...
Object.assign(window, {
  React, Ico, CLASS_META, CLASS_KEY_TO_META, SERIES, ALL_SPARK,
  fmt, fmtPct, mkSpark,
